...
from .views import get_upcoming_sessions,  CoachingSessionBookingView, CoachingSessionDetailView, CoachAvailabilityView, CoachScheduleView
...
urlpatterns = [
    ...
    path('sessions/upcoming/', get_upcoming_sessions),
    ]
