...
export const fetchEquipmentReservations = (equipmentId) => api.get('/api/coaching/equipment-reservations/', { params: equipmentId ? { equipment_id: equipmentId } : {} }).then(r => r.data)
