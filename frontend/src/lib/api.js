...
export const bookCoachingSession = (data) => authApi.post('/api/users/coaching-sessions/', data)
export const fetchMemberSessions = (memberId) => authApi.get(`/api/users/coaching-sessions/?member_id=${memberId}`)
export const cancelCoachingSession = (sessionId, memberId) => authApi.delete(`/api/users/coaching-sessions/${sessionId}/?member_id=${memberId}`)
