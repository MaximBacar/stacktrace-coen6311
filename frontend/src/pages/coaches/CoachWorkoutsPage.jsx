...
export default function CoachWorkoutsPage() {
    ...
    return (
      ...
      >
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-1">Create plans to assign to your clients.</p>
        </div>
  ...
  return (
    <motion.div className="h-full min-h-0 w-full flex flex-col px-6" variants={stagger} initial="hidden" animate="show">
      ...
      <motion.div variants={fadeUp} className="h-full min-h-0 grid grid-cols-1 md:grid-cols-[280px_1fr] gap-8">
